...
export const createProductZod = CoreProductZod.omit({
  sku: true,
  ratings: true,
  tags: true,
}).extend({
...
export const updateProductZod = CoreProductZod.omit({
  sku: true,
  ratings: true,
  tags: true,
}).partial();
...
export type CreateProductDTO = z.infer<typeof createProductZod>;
export type UpdateProductDTO = z.infer<typeof updateProductZod>;
export type UpdateProductStockDTO = z.infer<typeof updateStockZod>;
